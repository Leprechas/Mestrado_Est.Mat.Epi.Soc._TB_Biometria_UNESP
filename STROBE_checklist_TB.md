...
| 7 | Variáveis | Desfecho: incidência/100 mil (bruta e log); SIR; tendência. Preditores sociais: **a incluir**. **Parcial** |
...
| 12a | Métodos estatísticos | Prais-Winsten (VPA/IC95%); Moran global; LISA; Getis-Ord Gi\*; **Bayes empírico**; **varredura espaço-temporal (SaTScan)**. **OK** |
